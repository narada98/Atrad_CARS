...
log_dir = os.path.join(base_loc ,"logs/fit/retriever_port_v2_fixed_max_port_size_50/" + "retriever_v3_" + datetime.now().strftime("%Y%m%d_%H%M%S"))
...
model_name = 'retriever_v3_port_v2__fixed_max_port_size_50' 
